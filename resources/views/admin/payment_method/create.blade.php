            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form class="form-horizontal form-material" action="{{ route('admin.payment.store') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label class="col-md-12">Payment Name:</label>
                                <div class="col-md-12">
                                    <input type="text" name="payment_name" class="form-control form-control-line">
                                </div>
                            </div>
